...
import { Code2, Home, User, FileText, Bell, LogOut, Users, ClipboardList, MessageSquare, FileCheck, Menu, X } from 'lucide-react';
...
export function DashboardSidebar() {
  ...
  const studentLinks = [
    ...
    { path: '/dashboard/final-submission', label: 'Final Submission', icon: FileCheck },
  ];
      ...
      <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
        <Link to="/" className="flex items-center gap-2 text-sidebar-foreground">
          ...
          <div>
            ...
            <span className="text-xs text-muted-foreground">Induction Portal</span>
          </div>
        </Link>
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-40 h-14 bg-sidebar border-b border-sidebar-border flex items-center px-4 lg:hidden">
        ...
        <Link to="/" className="flex items-center gap-2 ml-3 text-sidebar-foreground">
