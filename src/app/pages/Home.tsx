  ...
  const modules = [
    {
      ...
      description:
        "Create comprehensive developer profiles with skills and experience",
    },
    {
      icon: ClipboardList,
  ...
  const projects = [
    {
      ...
      description:
        "The official web portal for NIT Patna serving thousands of students and faculty",
      tags: ["React", "Node.js", "PostgreSQL"],
    },
    {
      name: "TNP Portal",
      description:
        "Training & Placement management system for campus recruitment",
      tags: ["Next.js", "MongoDB", "AWS"],
    },
    {
      name: "Admin Panel",
      description:
        "Centralized administration dashboard for institutional management",
    ...
    },
    {
      ...
      description:
        "Performance evaluation and feedback system for faculty members",
      tags: ["Angular", "Spring Boot", "Oracle"],
    },
    {
      name: "More Institutional Systems",
      description:
        "Various tools and platforms serving the institute ecosystem",
      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            The Web Development Club builds and maintains the digital
            infrastructure powering NIT Patna's technological ecosystem.
          </p>
