    ...
    <div className="min-h-screen flex">
      ...
      <main className="flex-1 lg:ml-60 pt-14 lg:pt-0">
        <div className="max-w-7xl mx-auto p-4 sm:p-8">
          <h1 className="text-3xl font-semibold mb-8 text-foreground">Student Applications</h1>
              ...
              <table className="w-full">
                <thead className="bg-secondary/50 border-b border-border">
                  <tr>
                    ...
                    <th className="text-left px-6 py-3 text-sm font-semibold text-foreground">Branch</th>
                    <th className="text-left px-6 py-3 text-sm font-semibold text-foreground">Year</th>
                ...
                <tbody className="divide-y divide-border">
                  {filteredStudents.map((student) => (
                    <tr key={student.id} className="hover:bg-accent/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-foreground">{student.branch}</div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-foreground">{student.year}</div>
                      </td>
                      <td className="px-6 py-4">
